...
// clang-format off
KeyboardImplementation::InternalKeyCode GlfwKeyboardBackend::toInternalKeyCode(Key key)
{
    switch (key)
    {
    // Letters
...
Key GlfwKeyboardBackend::toKeyCode(KeyboardImplementation::InternalKeyCode code)
{
    switch (code)
    {
    // Letters
